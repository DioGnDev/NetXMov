  ...
  var body: some View {
    HStack(alignment: .top) {
      ...
      VStack(alignment: .leading, spacing: 20) {
        DetailTextView(title: "Title", value: movie.title)
        DetailTextView(title: "Popularity", value: "\(movie.popularity)")
        DetailTextView(title: "Release Date", value: movie.releaseDate)
        Spacer()
      }.padding(.top, 10)
